...
(function () {
  ...
  var KB = [
    ...
    },
    {
      ...
      a: "Five roles across education, logistics and admissions:<br><br><b>1. Data &amp; AI Platform Engineer</b> · Peblink / WLRC · Jan 2026 to present<br>Speech-AI reading assessment, serverless AWS pipelines.<br><br><b>2. AI / Data Analyst (Intern)</b> · Peblink / WLRC · May 2025 to Jan 2026<br>Architected the WLRC global literacy data hub blueprint in 8 weeks; benchmarked 30+ public sources; secured a <b>Washington D.C. meeting with Congressman Brad Schneider</b>.<br><br><b>3. AI Workflow / Data Engineer (Intern)</b> · KAYAAN Inc. · Aug to Dec 2025<br>n8n AI-agent outreach workflow driving a <b>24% investor connection rate</b>; React dashboard with 15+ KPIs.<br><br><b>4. Graduate Assistant, Data &amp; AI</b> · Yeshiva University, Shevet Glaubach Career Center · Jan to Dec 2025<br>Co-built <b>FELIX</b>, a RAG chatbot; eliminated <b>40+ staff hours/week</b> of manual reporting.<br><br><b>5. Graduate Assistant, AI &amp; Admissions</b> · Yeshiva University, Katz School · Jun 2024 to Aug 2025<br>Admissions ChatGPT assistant and Power BI funnel reporting."
    },
    {
      id: "research",
    ...
    },
    {
      ...
      a: "<b>M.S. Data Analytics &amp; Visualization</b><br>Yeshiva University, Katz School of Science &amp; Health · New York<br>GPA <b>3.95</b> · Jan 2024 to Jan 2026<br><br><b>Bachelor of Computer Applications</b><br>Andhra University · India<br>GPA <b>4.0/4.0</b>, graduated as <b>Gold Medalist</b> · Jun 2019 to Jul 2022"
    },
    {
      id: "awards",
  ...
  css.textContent = [
    "#ab{position:fixed;bottom:22px;right:22px;z-index:150;width:58px;height:58px;border-radius:50%;",
      ...
      "background:linear-gradient(100deg,#3ddcf5,#818cf8 45%,#e879f9);display:grid;place-items:center;",
    ...
    ".ah-av{width:36px;height:36px;border-radius:50%;background:linear-gradient(100deg,#3ddcf5,#818cf8);",
      "display:grid;place-items:center;color:#04050d;font-weight:700;font-size:.9rem;flex-shrink:0}",
    ".ah-t{font-weight:700;font-size:.94rem;color:#ffffff;line-height:1.25}",
    ".ah-s{font-family:'JetBrains Mono',monospace;font-size:.65rem;color:#9db0d0;letter-spacing:.06em}",
    ".ah-x{margin-left:auto;background:none;border:0;color:#c3d1e8;font-size:1.25rem;cursor:pointer;padding:4px 6px;line-height:1}",
    ".ah-x:hover{color:#3ddcf5}",
    ...
    ".msg.b{align-self:flex-start;background:rgba(18,26,52,.85);border:1px solid var(--line,rgba(120,160,255,.16));color:#eaf1fc;border-bottom-left-radius:5px}",
    ".msg.u{align-self:flex-end;background:linear-gradient(100deg,rgba(34,211,238,.17),rgba(129,140,248,.17));",
      "border:1px solid rgba(34,211,238,.3);color:#ffffff;border-bottom-right-radius:5px}",
    ".msg a{color:#3ddcf5;text-decoration:none;border-bottom:1px solid rgba(34,211,238,.35)}",
    ".msg a:hover{color:#a5f3fc}",
    ".msg b{color:#ffffff}",
    ".chips{display:flex;flex-wrap:wrap;gap:7px;padding:0 17px 13px;flex-shrink:0}",
    ".chip{background:rgba(18,26,52,.8);border:1px solid var(--line,rgba(120,160,255,.16));color:#c3d1e8;",
      "padding:6px 12px;border-radius:100px;font-size:.755rem;cursor:pointer;transition:.22s;",
      "font-family:'Space Grotesk',sans-serif}",
    ".chip:hover{border-color:rgba(34,211,238,.45);color:#3ddcf5}",
    ...
    ".af input{flex:1;background:rgba(10,15,32,.85);border:1px solid var(--line,rgba(120,160,255,.16));",
      "border-radius:100px;padding:10px 15px;color:#eaf1fc;font-size:.865rem;font-family:'Space Grotesk',sans-serif}",
    ".af input:focus{outline:none;border-color:#3ddcf5}",
    ".af button{width:39px;height:39px;border-radius:50%;border:0;cursor:pointer;color:#04050d;flex-shrink:0;",
      "background:linear-gradient(100deg,#3ddcf5,#818cf8);font-size:1rem;display:grid;place-items:center}",
    ".af button:disabled{opacity:.45;cursor:default}",
    ".typing{display:flex;gap:4px;align-items:center;padding:12px 15px}",
    ".typing i{width:6px;height:6px;border-radius:50%;background:#3ddcf5;display:block;animation:tp 1.3s infinite}",
    ...
    ".jump{margin-top:11px;display:inline-flex;align-items:center;gap:7px;background:rgba(34,211,238,.1);",
      "border:1px solid rgba(34,211,238,.34);color:#3ddcf5;padding:6px 13px;border-radius:100px;",
